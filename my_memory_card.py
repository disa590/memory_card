...
window.score= 0
questions_list = []
questions_list.append(Question('Как вы приветствуете людей при знакомстве?','Кивком','Взмахом руки','Рукопожатием','Поклоном'))
questions_list.append(Question('Государственный язык Бразилии','Португальский','Английский','Русский', 'Бразильский'))
